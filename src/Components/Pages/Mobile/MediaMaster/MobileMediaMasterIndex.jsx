...
const MobileMediaMasterIndex = (props) => {
  ...
  const column = [
    ...
    },
    {
      ...
      Cell: ({ cell }) => (
        <>
          <span className="font-bold my-1 px-2">Tags:</span> {nullToNA(cell?.row?.original?.tags)}
        </>
      ),
    },
    {
      ...
      Cell: ({ cell }) => (
        <>
        <span className="font-bold my-1 px-2">Uploaded At:</span> {indianDate(cell.row.original.created_date)}
        </>
      ),
      className: ""
    },
    {
      ...
      accessor: "id",
      Cell: ({ cell }) => (
        <div className="flex flex-row px-2 gap-2 my-2">
          <button
...
const deleteFun = () => {
  ...
  return (
    <>
      ...
      {!props?.addMedia && <div className="poppins p-4">
...
export default MobileMediaMasterIndex