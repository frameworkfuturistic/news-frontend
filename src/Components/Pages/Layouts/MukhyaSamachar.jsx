...
const MukhyaSamachar = (props) => {
  ...
  return (
    <>
      ...
      <div id={props?.data?.categoryId} className='border-t rounded-lg  p-2  border-b h-full md:h-[35rem] w-full bg-slate-600  flex flex-col md:px-4 px-2 mb-4 md:mb-6 relative'>
